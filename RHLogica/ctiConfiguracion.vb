...
Public Class ctiConfiguracion
    ''''''''''''''''Horario
    Public Function actualizarHorarios(ByVal dialimitecaptura As String, ByVal horalimitecapura As Integer) As String
        Dim err As String
        ...
        Dim cmd As New SqlCommand("UPDATE Configuracion SET dialimitecaptura = @dialimitecaptura, horalimitecapura = @horalimitecapura", dbC)
        cmd.Parameters.AddWithValue("dialimitecaptura", dialimitecaptura)
        cmd.Parameters.AddWithValue("horalimitecapura", horalimitecapura)
    ...
    Public Function datosHorario() As String()
        ...
        If rdr.Read Then
            ...
            dsP(1) = rdr("horalimitecapura").ToString
        Else
