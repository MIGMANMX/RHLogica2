...
Public Class ctiCalendario
    ...
    Public Function datosParticulares(ByVal idparticulares As Integer) As String()
        ...
        Return dsP
    End Function
    Public Function agregarParticulares(ByVal idempleado As Integer, ByVal tipo As Integer, ByVal fecha As String, ByVal observaciones As String, ByRef cantidad As Integer) As String()
        Dim ans() As String
        If tipo <> 0 Then
            Dim dbC As New SqlConnection(StarTconnStrRH)
            dbC.Open()
            ...
            Else
                ...
                cmd.ExecuteNonQuery()
                cmd.CommandText = "SELECT idparticulares FROM Particulares WHERE tipo = @tipo AND fecha = @fecha"
                rdr = cmd.ExecuteReader
                rdr.Read()
                ReDim ans(1)
                ans(0) = "Agregado."
        ...
        Return ans
    End Function
    Public Function actualizarParticulares(ByVal idparticulares As Integer, ByVal idempleado As Integer, ByVal tipo As Integer, ByVal fecha As String, ByVal observaciones As String, ByVal cantidad As Integer, ByVal fecha_ued As String) As String
        'Dim err As String
        'If jornada = "" Then
        '    err = "Error: no se actualizó, es necesario capturar el puesto de empleado."
        'Else
